<template>
	...
	-->  
	<view class="article">
		<unicloud-db v-slot:default="{data, loading, error, options}" :options="formData" collection="news-articles-detail" :where="where" :field="field"
